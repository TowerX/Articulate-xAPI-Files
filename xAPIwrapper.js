     ...
     * You need to identify the URL for your LRS endpoint.
     * Typically, it's in the same "area" in the GUI where records are displayed.
     * 
     * You also need to identify how the LRS allows access to your space.  
     * Is it through a username/password?  Key/secret?  
     * 
     * The content of those 3 variables need to be put in the Config function to be able to push & pull using the LRS.
     * 
    ...
    var Config = function()
    {
        ...
        var conf = {
            "endpoint" : "https://myLRS.io.pleasework",
...
/****************************
 * It's not necessary to edit anything underneath this line for typical functionality.
 * 
 * It's all just code, so feel free to play with it.  But know that as long as the LRS configured properly above, everything below should work.
 *****************************/
